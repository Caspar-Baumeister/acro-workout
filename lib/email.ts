...
export function formatPlanAsEmailBody(plan: TrainingPlanOutput): string {
  ...
  const profileHtml = `
    <table style="width: 100%; font-size: 14px; margin-bottom: 20px;">
      ...
      <tr><td style="padding: 6px 12px 6px 0; color: #666;">Style:</td><td style="padding: 6px 0;"><strong>${plan.profile.acrobaticsType}</strong></td></tr>
      <tr><td style="padding: 6px 12px 6px 0; color: #666;">Level:</td><td style="padding: 6px 0;"><strong>${plan.profile.level}</strong></td></tr>
      <tr><td style="padding: 6px 12px 6px 0; color: #666;">Goals:</td><td style="padding: 6px 0;"><strong>${plan.profile.goals.join(', ')}</strong></td></tr>
      ...
      <tr><td style="padding: 6px 12px 6px 0; color: #666;">Equipment:</td><td style="padding: 6px 0;"><strong>${plan.profile.equipment.length > 0 ? plan.profile.equipment.join(', ') : 'Bodyweight'}</strong></td></tr>
